...
public class ClassifierBISINDO extends Classifier {
     ...
     */
    public ClassifierBISINDO(Activity activity, Device device, int numThreads)
            throws IOException {
    ...
    protected String getModelPath() {
        ...
        return "alphabets_metadata.tflite";
    }
}
